...
add_filter( 'plugin_action_links_' . plugin_basename(__FILE__), 'sbs_plugin_action_links' );

function sbs_plugin_action_links( $links ) {
  $links[] = '<a href="http://www.kylembrown.com/step-by-step-help?utm_source=wordpress_org&utm_medium=plugin_upgrade_link&utm_campaign=step_by_step" target="_blank">Help</a>'; 
  $links[] = '<a href="http://www.wpdocs.co/?utm_source=wordpress_org&utm_medium=plugin_upgrade_link&utm_campaign=step_by_step" target="_blank">Upgrade to Pro</a>';
$links[] = '<a href="https://wordpress.org/support/view/plugin-reviews/step-by-step" target="_blank">Rate this add-on!</a>';
   return $links;
}
   ...
   <div class="sidebar-container" style="width:30%;float:right; background-color: #FFFFFF;border: 1px solid #E5E5E5;border-radius: 0;font-size: 15px;margin-bottom: 15px;padding: 0;position: relative;text-align: left;">
	<div class="sidebar-content" style="padding:14px;">
		<p><h3><?php _e( 'Get the Pro version'); ?></h3></p>
				...
				<div class="centered">
					<a href="https://cart.wpdocs.co/?utm_source=step-by-step&utm_medium=sidebar&utm_campaign=Step-by-Step"
	...
	<div class="sidebar-content" style="padding:14px;">
     ...
     <?php //Blog Post
      wp_widget_rss_output(array(
												'url' => 'http://wpdocs.co/feed/?utm_source=wordpress_org_descpage&utm_medium=link&utm_campaign=step_by_step',
												'title' => 'SeedProd Blog',
												'items' => 3,
												'show_summary' => 0,
												'show_author' => 0,
      ...
      ?>
		...
		<p>
			<a href="http://wpdocs.co/blog/" class="button-primary" target="_blank">
				<?php _e('Visit our Blog'); ?></a>
		</p>
	</div>
</div>  
